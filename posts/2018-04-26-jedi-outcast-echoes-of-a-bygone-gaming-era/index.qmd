...
date: "2018-04-26 14:30:00"
categories: [personal, gaming, star wars, fps, communities]
citation:
    url: https://magsol.github.io/posts/2018-04-26-jedi-outcast-echoes-of-a-bygone-gaming-era/
image: "lolrob.jpg"
image-alt: "Looking downscope of a sniper rifle in Jedi Outcast 2 zoomed in hilariously right on a friend's avatar's face."
author: "Shannon Quinn"
---

![](lolrob.jpg){.preview-image fig-alt="Looking downscope of a sniper rifle in Jedi Outcast 2 zoomed in hilariously right on a friend's avatar's face."}
...
![Source: https://www.gog.com/game/star_wars_jedi_knight_ii_jedi_outcast](jedi_outcast_gog.jpg){fig-alt="The original Jedi Knight II: Jedi Outcast logo."}
...
![](jk2_play.jpg){fig-alt="A screenshot of mid-gameplay in Jedi Outcast."}
...
![](chat_gui.jpg){fig-alt="A screenshot like before, but this time showing lots of players standing around mid-game chatting with each other."}
...
![](poticon.jpg){fig-alt="The Power of Thee, or PoT, logo."}
...
![](duel.jpg){fig-alt="An in-game screenshot of two players in the middle of a lightsaber duel."}
...
![](pot_v_tmbj1.jpg){fig-alt="Screenshot of an in-game scoreboard showing the points and results of the first round of a match."}
...
![](pot_v_tmbj2.jpg){fig-alt="Screenshot from the middle of the match, from the perspective of one of the TMBJ players."}

![](pot_v_tmbj3.jpg){fig-alt="Screenshot from the middle of the match, from the perspective of one of the PoT players."}
...
![](mag_year.jpg){fig-alt="A stylized photoshop image of the variations of my in-game avatar to show their progression over the years, from beginner to expert."}
...
![](mag_skin.jpg){fig-alt="An in-game screenshot showing the details of my avatar's modifications I'd made."}
...
![](rob_startup_screen.bmp){fig-alt="A variation of the Jedi Outcast startup screen in Windows, this one absolutely ruined by Rob's awful MS Paint skills and with no backup to restore the original."}
...
![](tahiri_snipe.jpg){fig-alt="A screenshot of Tahiri through a sniper rifle."}
...
![](recruiting.jpg){fig-alt="A screenshot of the in-game scoreboard, showing the names of lots of new recruits into PoT."}

Our renewed membership enabled us to engage in more inter-clan matches. We even managed to win a few of them!

![Didn't do so well here--if TMBJ was #1, UJ was #2. Especially in saber duels, they were unstoppable.](uj.jpg){fig-alt="Screenshot of in-game scoreboard during the match with UJ, showing us kinda getting slaughtered."}

![NJOC was a much smaller clan, and through a rigorous practice regimen in the weeks leading up to the match, we actually ended up winning!](njoc.jpg){fig-alt="Screenshot of in-game scoreboard during the match against NJOC, showing PoT with a slim edge."}
...
![](do_logo.jpg){fig-alt="Delta Order logo, basically a stylized capital greek Delta with a lens flare."}
...
![](bracket_saber.jpg){fig-alt="Photoshop built graphic of tournament brackets for the FFA competition."}

![](brackets_ffa.jpg){fig-alt="Photoshop built graphic of tournament brackets for the saber duel competition."}
...
![](demoted.jpg){fig-alt="AOL IM logs showing Tahiri's reaction to our April Fool's Day posts, both before and after he realized it was a prank."}
...
![](tahiri_haha.jpg){fig-alt="Tahiri, the IRL Tahiri, hiding behind some bushes."}